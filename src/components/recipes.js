export const recipes = [ // Exports an array of recipe objects
  ...
  
  {
    ...
    instructions: "Heat the Oil:In a large pan or wok, heat the vegetable oil over medium-high heat. Add Vegetables:Add the bell pepper, broccoli, snap peas, carrot, and onion. Stir-fry for about 5 minutes, or until the vegetables are tender-crisp.Add Garlic:Stir in the minced garlic and cook for another minute.Add Sauces:Stir in the soy sauce, hoisin sauce, and sesame oil. Cook for an additional 2 minutes. If desired, add the cornstarch mixture to thicken the sauce.Season:Adjust seasoning with salt and pepper to taste.Serve: Serve the stir-fry over cooked rice or noodles.Enjoy your vegetable stir-fry!",
  ...
  
  {
    ...
    type: "non-veg",
    description: "A creamy and savory beef stroganoff served over noodles.",
    ingredients: [
